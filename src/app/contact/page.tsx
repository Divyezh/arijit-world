    ...
    <div className="pt-(--nav-height)">
      <section className="relative py-20 md:py-28">
        <div className="section-container text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gold-gradient mb-4" style={{ fontFamily: "var(--font-display)" }}>CONTACT</h1>
        ...
        <div className="section-container max-w-2xl">
          {submitted ? (
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-amber-100 mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Message Sent!
              </h2>
            ...
            <form onSubmit={handleSubmit} className="glass-light rounded-2xl p-8 space-y-6">
              <div>
                <label htmlFor="contact-name" className="block text-xs tracking-widest uppercase text-amber-400/60 mb-2" style={{ fontFamily: "var(--font-heading)" }}>
                  Name
                </label>
                <input
                  id="contact-name"
              ...
              <div>
                <label htmlFor="contact-email" className="block text-xs tracking-widest uppercase text-amber-400/60 mb-2" style={{ fontFamily: "var(--font-heading)" }}>
                  Email
                </label>
                <input
                  id="contact-email"
              ...
              <div>
                <label htmlFor="contact-type" className="block text-xs tracking-widest uppercase text-amber-400/60 mb-2" style={{ fontFamily: "var(--font-heading)" }}>
                  Type
                </label>
                <select
                  id="contact-type"
                ...
                >
                  <option value="general" className="bg-[#141414]">General Feedback</option>
                  <option value="metadata" className="bg-[#141414]">Metadata Correction</option>
                  <option value="article" className="bg-[#141414]">Article Submission</option>
                  <option value="other" className="bg-[#141414]">Other</option>
                </select>
              </div>
              <div>
                <label htmlFor="contact-message" className="block text-xs tracking-widest uppercase text-amber-400/60 mb-2" style={{ fontFamily: "var(--font-heading)" }}>
                  Message
                </label>
                <textarea
                  id="contact-message"
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-xl font-semibold text-sm tracking-widest uppercase flex items-center justify-center gap-2 transition-all duration-300 hover:scale-[1.02]"
                style={{
